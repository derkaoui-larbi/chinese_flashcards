  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<FlashcardsNotifier>(
      builder: (_, notifier, __) {
        final word = notifier.currentTopic.isNotEmpty && notifier.selectedWords.length > 1 ? notifier.selectedWords[1] : null;
            ...
            child: SlideAnimation(
              ...
              child: Center(
                child: Container(
                  ...
                  child: word != null ? Transform(
                    alignment: Alignment.center,
                    transform: Matrix4.rotationY(pi),
                    child: CardDisplay(word: word),
                  ) : const SizedBox(),
                ),
              ),
            ),
